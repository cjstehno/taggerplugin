 ...
 */
abstract class AbstractTagAssociationExternalizationWizard extends Wizard {

	private TagAssociationExternalizationWizardPage page;
	private final TagAssociationExternalizationWizardType wizardType;

	protected AbstractTagAssociationExternalizationWizard(TagAssociationExternalizationWizardType type){
		super();
	...
	public void addPages() {
		this.page = new TagAssociationExternalizationWizardPage(wizardType);
		addPage(page);
	}
